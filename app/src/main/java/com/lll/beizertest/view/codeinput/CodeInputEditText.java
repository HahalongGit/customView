...
public class CodeInputEditText extends android.support.v7.widget.AppCompatEditText{
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (characters != null) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                Log.e("TAG","onTextChanged-character"+character);
    ...
    private void drawSection(int position, float fromX, float fromY, float toX, float toY,
        ...
        Log.e("TAG","drawSection-position:"+position);
        Log.e("TAG","drawSection-characters:"+characters.size() );
    ...
    private void drawCharacter(float fromX, float toX, Character character, Canvas canvas) {
        ...
        Log.e("TAG","drawCharacter-character:"+character.toString());
        Log.e("TAG","drawCharacter-displayingChar:"+displayingChar);
