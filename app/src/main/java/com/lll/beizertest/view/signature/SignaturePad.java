package com.lll.beizertest.view.signature;
...
/**
 * 自定义画板
 * 项目原址：https://github.com/gcacace/android-signaturepad
 */
public class SignaturePad extends View {
    ...
    private TimedPoint getNewPoint(float x, float y) {
        ...
        if (mCacheSize == 0) {
            // Cache is empty, create a version_new point
    ...
    private void addPoint(TimedPoint newPoint) {
        ...
        if (pointsCount > 3) {
            ...
            // The version_new width is a function of the velocity. Higher velocities
            // correspond to thinner strokes.
            float newWidth = strokeWidth(velocity);

            // The Bezier's width starts out as last curve's final width, and
            // gradually changes to the stroke width just calculated. The version_new
