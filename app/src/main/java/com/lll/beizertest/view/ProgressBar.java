...
public class ProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(rectF,0,rade*360,false,mInnerPaint);
        ...
        //绘制一个水平进度条
        canvas.drawLine(mProgressBorderWidth/2,getHeight()/2,getWidth()-mProgressBorderWidth/2,getHeight()/2,mOuterPaint);
