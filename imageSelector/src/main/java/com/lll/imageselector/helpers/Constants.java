package com.lll.imageselector.helpers;
...
public class Constants {
     ...
     * 拍照路径
     */
    public static File FILE_SAVE_PATH = new File(Environment.getExternalStoragePublicDirectory("kbb_finance"),"/camera");

    /**
     * 裁剪缓存
     */
    public static File FILE_SAVE_CACHE_PATH = new File(Environment.getExternalStoragePublicDirectory("kbb_finance"),"/camera/cache");
}
